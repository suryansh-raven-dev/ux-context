...
function WithActionsDialogPreview() {
  const [open, setOpen] = useState(false);
...
function WithFormDialogPreview() {
  const [open, setOpen] = useState(false);
...
function FullWidthDialogPreview() {
  const [open, setOpen] = useState(false);
...
export const Dialog: Story = {
  ...
  render: () => (
    <StorybookPage maxWidth={760}>
      <StorybookSection title="Default"><DefaultDialogPreview /></StorybookSection>
      <StorybookSection title="With Actions"><WithActionsDialogPreview /></StorybookSection>
      <StorybookSection title="With Form"><WithFormDialogPreview /></StorybookSection>
      <StorybookSection title="Full Width"><FullWidthDialogPreview /></StorybookSection>
    </StorybookPage>
  ),
};
